...
public class Database {
    ...
    public static Database getInstance() {
        if (instance == null) {
            try {
                ...
                instance = new Database("jdbc:mysql://localhost:3306/tradingSystem", "root", "saibaba18baba");
    ...
    public Connection getConnection() throws SQLException {
        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/tradingSystem", "root", "saibaba18baba");
        return conn;
    }
